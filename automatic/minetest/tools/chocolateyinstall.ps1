...
$packageArgs = @{
  ...
  file          = "$toolsDir\minetest-5.7.0-win32.zip"
  file64        = "$toolsDir\minetest-5.7.0-win64.zip"
}
...
$targetPath = Join-Path "$toolsLocation" "minetest-5.7.0-win$(Get-OSArchitectureWidth)\bin\minetest.exe"
