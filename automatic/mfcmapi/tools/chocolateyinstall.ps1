...
$file64      = "$toolsDir\MFCMAPI.x64.exe.22.0.22216.01.zip"
...
Get-ChocolateyUnzip -PackageName $packageName -Destination "$InstallDir\x64" -FileFullPath "$toolsDir\MFCMAPI.x64.exe.22.0.22216.01.zip"
