...
$file64      = "$toolsDir\MFCMAPI.x64.exe.21.0.21127.03.zip"
...
Get-ChocolateyUnzip -PackageName $packageName -Destination "$InstallDir\x64" -FileFullPath "$toolsDir\MFCMAPI.x64.exe.21.0.21127.03.zip"
